...
function printStrings(array) {
  ...
  const String1 = array.toString();

  const repeatedString = String1.repeat(2);
...
function replaceNumbers(arr) {
  ...
  for (let b = 0; b < arr.length; b++) {
    if (arr[b] > 10) {
      arrNumbers.push("Greater than 10");
    } else {
      arrNumbers.push("Less than or equal to 10");
    }
  }
  return arrNumbers;
}
